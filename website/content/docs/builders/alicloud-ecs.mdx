...
[alicloud_windows.json](https://github.com/Bourne-ID/packer/tree/master/examples/alicloud/basic/alicloud_windows.json)
and
[winrm_enable_userdata.ps1](https://github.com/Bourne-ID/packer/tree/master/examples/alicloud/basic/winrm_enable_userdata.ps1)
for details.

See the
[examples/alicloud](https://github.com/Bourne-ID/packer/tree/master/examples/alicloud)
