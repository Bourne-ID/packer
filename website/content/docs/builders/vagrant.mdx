...
- `template` (string) - a path to a golang template for a
  ...
  [here](https://github.com/Bourne-ID/packer/blob/master/builder/vagrant/step_create_vagrantfile.go#L23-L37). So far the only template variables available to you are `{{ .BoxName }}` and
