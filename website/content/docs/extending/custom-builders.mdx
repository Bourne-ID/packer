...
[multistep](https://github.com/Bourne-ID/packer/blob/master/helper/multistep)
...
documentation](https://github.com/Bourne-ID/packer/blob/master/packer/artifact.go).
