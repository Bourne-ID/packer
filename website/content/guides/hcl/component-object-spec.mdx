...
package and is located in [`cmd/mapstructure-to-hcl2`](https://github.com/Bourne-ID/packer/tree/master/cmd/mapstructure-to-hcl2).
...
- run `go install github.com/Bourne-ID/packer/cmd/mapstructure-to-hcl2`
...
A good example of this is the [Config struct of the amazon-ebs builder](https://github.com/Bourne-ID/packer/blob/master/builder/amazon/ebs/builder.go)
